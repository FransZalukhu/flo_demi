...
<head>
    @include('layouts.superadmin.partials.head', ['pageTitle' => 'Edit Admin — Flodemi'])
</head>
    ...
    <div class="flex">
        ...
        <div class="main-wrapper w-full flex flex-col min-h-screen" id="mainWrapper">
            ...
            <main class="flex-1 p-6 md:p-8">
                {{-- Page Header --}}
                <div class="mb-8">
                    <h2 class="text-xl md:text-2xl font-extrabold text-slate-800 dark:text-white tracking-tight">Edit Data Admin</h2>
                    <p class="text-xs text-slate-500 dark:text-slate-400 mt-1">Perbarui data Admin pada formulir di bawah ini.</p>
                    ...
                    <nav class="flex items-center gap-2 text-[10px] font-bold text-slate-400 mt-3 uppercase tracking-wider">
                        ...
                        <span class="text-slate-300">/</span>
                        <span class="text-slate-500 dark:text-slate-300">Edit Admin</span>
                    </nav>
                </div>
                ...
                <div class="w-full max-w-3xl mx-auto">
                    ...
                    <div class="bg-white dark:bg-[#13111c] border border-slate-100 dark:border-slate-800 rounded-3xl shadow-xl overflow-hidden">
                        <div class="px-6 py-5 border-b border-slate-100 dark:border-slate-900 flex items-center gap-2">
                            <i class="ri-user-settings-line text-lg text-brand-purple"></i>
                            <h3 class="text-sm font-extrabold text-slate-800 dark:text-white">Formulir Edit Admin</h3>
                        </div>

                        <div class="p-6 md:p-8">
                            <form action="{{ route('superadmin.admin.update', $admin->id) }}" method="POST" class="space-y-6">
                                @csrf
